...
func columns() []colDef {
	...
	return []colDef{
		...
		{key: "prs_merged", title: "Merged", width: 6, priority: 1,
		...
		{key: "changes_req", title: "ChgRq", width: 5, priority: 3,
		...
		{key: "c_given", title: "CGivn", width: 5, priority: 4,
		...
		{key: "c_recv", title: "CRecv", width: 5, priority: 4,
